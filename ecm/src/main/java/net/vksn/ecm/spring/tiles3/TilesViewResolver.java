package net.vksn.ecm.spring.tiles3;
...
public class TilesViewResolver extends UrlBasedViewResolver {
	...
	private String tilesContainerKey;

	
	public void setTilesContainerKey(String tilesContainerKey) {
		this.tilesContainerKey = tilesContainerKey;
	}
	...
	protected TilesView buildView(String viewName) throws Exception {
		...
		view.setContainerKey(this.tilesContainerKey);
		return view;
	}
